		...
		<section id="content">
			<div class="content-wrap pt-0 bg-light">
				<div class="container">
					...
					<!-- Entry Image
					============================================= -->
					<div class="entry-image align-wide-full min-vh-50 d-flex align-items-center justify-content-center px-5" style="background: url('images/blog/full/2.jpg') no-repeat center center / cover;">

						<div class="p-4 bg-white position-relative rounded text-sm-center mw-xs">

							<!-- Entry Title
							============================================= -->
							<h2 class="mb-3">This is a Standard post with a Preview Image</h2>
...
padding-top: 40px;
								...
								<div class="row align-wide-xl mb-4 text-center">
									...
									<div class="col-sm-6">
										<img src="images/blog/grid/2.jpg" alt="Image">

					...
					<div class="col-md-5">
						<div class="dark h-100 min-vh-md-100 d-flex flex-column justify-content-between p-5" style="background-image: radial-gradient(circle at 100% 0%, #CC135C 0%, #CC135C 10%, transparent 10%,  transparent 100%), radial-gradient(circle at 90% 103%, transparent 30%, #3D1144 30%, #3D1144 100%),linear-gradient(90deg, #FF736E,#FF736E);">
							...
							<div><div class="feature-box fbox-sm mb-4">
									<div class="fbox-icon">
										<i class="bi-geo-alt bg-transparent text-white p-0"></i>
									</div>
								...
								<div class="feature-box fbox-sm mb-4">
									<div class="fbox-icon">
										<i class="bi-telephone-outbound bg-transparent text-white p-0"></i>
									</div>
									<div class="fbox-content">
										<h4 class="text-transform-none font-body fw-normal mb-2"><a class="text-white" href="tel:+122-55412474">+00 111 232 11 33</a></h4>
									</div>
								</div>
								<div class="feature-box fbox-sm mb-5 mb-md-0">
									<div class="fbox-icon">
										<i class="bi-envelope bg-transparent text-white p-0"></i>
									</div>
									<div class="fbox-content">
										<h4 class="text-transform-none font-body fw-normal mb-2"><a class="text-white" href="mailto:noreply@canvas.com">noreply@canvas.com</a></h4>
									</div>
								</div>
							</div>
							...
							<div>
								...
								<a href="#" class="social-icon rounded-circle border-0 rounded-circle h-bg-x-twitter">
							...
							<form class="mb-0" id="template-contactform" name="template-contactform" action="include/form.php" method="post">
								...
								<div class="row">
									...
									<div class="col-12 form-group mb-0 text-end">
										<button class="button button-large rounded m-0 py-3 px-5" type="submit" id="template-contactform-submit" name="template-contactform-submit" value="submit" style="background-color: #3D1144;">Send Message</button>
									</div>
								</div>

								...
								<form class="mb-0" id="template-contactform" name="template-contactform" action="include/form.php" method="post">
									...
									<div class="row">
										...
										<div class="col-12 mb-5 mb-lg-6">
											...
											<input type="email" id="template-contactform-email" name="template-contactform-email" value="" placeholder="noreply@semicolonweb.com" class="required email form-control form-control-lg">
										</div>
